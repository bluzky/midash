  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: MidashWeb.Layouts]

      use Gettext, backend: MidashWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: MidashWeb.Endpoint,
        router: MidashWeb.Router,
        statics: MidashWeb.static_paths()
    end
  end
