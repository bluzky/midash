<script>
  ...
  const STARTER =
    "# `input` is available as a variable\n# Example: String.upcase(input)\ninput\n";
    ...
    <div class="flex flex-col gap-4">
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="flex flex-col gap-1">
          ...
          >
          <div
            class="flex h-64 w-full rounded-md border border-border bg-card font-mono text-sm text-foreground overflow-auto focus-within:border-primary focus-within:ring-1 focus-within:ring-primary/20"
          >
            <div
              bind:this={lineNumEl}
              aria-hidden="true"
