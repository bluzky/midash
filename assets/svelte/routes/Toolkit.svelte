<script>
  ...
  const TOOLS = [
    {
      id: "elixir-execute",
      label: "Elixir Execute",
      description: "Run Elixir code with an input string",
      path: "/toolkit/elixir-execute",
      icon: Terminal,
    },
    {
      id: "barcode",
      ...
      description:
        "Generate Code128 barcodes, one per line, printable 2-column grid",
      path: "/toolkit/barcode",
      icon: Barcode,
    },
    {
      id: "postbin",
      label: "PostBin",
      description:
        "Inspect HTTP requests — capture headers, query params, and body in real time",
      path: "/toolkit/postbin",
      icon: Globe,
    },
    {
      id: "mau",
      label: "Mau Template",
      description:
        "Render Mau (Liquid-inspired) templates with JSON context params",
      path: "/toolkit/mau",
      icon: FileCode,
    },
    {
